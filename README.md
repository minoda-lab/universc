...
![MicroBadger Layers (latest)](https://img.shields.io/microbadger/layers/tomkellygenetics/universc/latest?label="layers@1.1.5")
![Docker Image Size (v1.1.5)](https://img.shields.io/docker/image-size/tomkellygenetics/universc/1.1.5?label="image%20size@1.1.5)
